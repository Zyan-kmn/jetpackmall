...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="{{route('index')}}">
                <img src="{{asset('logo/logo_transparent.png')}}" 
                alt="">
            </a>
        </div>
            ...
            <ul>
                <li>
                    <a href="{{route('cart')}}"><i class="fa fa-shopping-bag"></i> 
                        <span class="shoppingcartNoti"></span>
                    </a>
                </li>
            </ul>
            <a href="">
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="javascript:void(0)">
                                ...
                                <button type="submit"  class="searchBtn site-btn">SEARCH</button>
                            </form>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="'footer__copyright__payment"><img src="{{asset('frontend/img/payment-item.png')}}"></div>
                    </div>
                </div>
            </div>
        </div>
