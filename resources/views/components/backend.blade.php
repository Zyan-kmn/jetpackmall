...
<html lang="en">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <li>
                     ...
                     <li><a href="javascript:void(0)" class="dropdown-item"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">                             <i class="icofont-logout"></i>Logout  </a>
 ...
 -->                  </ul>
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset(Auth::user()->profile)}}" alt="" class="userprofile" style="width: 50px; height: 50px;" >
                  <div>
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="{{route('orderlist')}}">
